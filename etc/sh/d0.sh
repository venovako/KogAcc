...
do
	OMP_NUM_THREADS=1 ${HOME}/Downloads/VecJac/src/tdgesvj-lp64_3q.exe ${I} ${I} dR${I} >> d0.out 2>> d0.err &
	sleep 1
done
wait
echo '"N", "TIMEs", "SWEEPS", "SVDRES", "UORTHO", "VORTHO", "MINAE", "MAXAE", "AVGAE", "MINRE", "MAXRE", "AVGRE"' > d0.csv
for ((I=128;I<=5376;I+=128))
do
	B=dR${I}
