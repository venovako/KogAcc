...
do
	B=s${I}
	A=`OMP_NUM_THREADS=64 ${HOME}/Downloads/JACSD/tgensvd/serrsvd.exe ${I} ${I} ${B}.G ${B}.U$1 ${B}.S$1 ${B}.V$1`
	U=`OMP_NUM_THREADS=64 ${HOME}/Downloads/JACSD/tortho/sortho.exe ${B}.U$1 ${I} ${I}`
	V=`OMP_NUM_THREADS=64 ${HOME}/Downloads/JACSD/tortho/sortho.exe ${B}.V$1 ${I} ${I}`
