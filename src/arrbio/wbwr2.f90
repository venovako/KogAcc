!>@brief \b WBWR2 writes a two-dimensional extended precision complex array to a binary file.
!!
...
SUBROUTINE WBWR2(U, M, N, G, LDG, INFO)
  IMPLICIT NONE
  ...
  IF (N .EQ. 0) RETURN
  DO J = 1, N
     CALL WBWR1(U, M, G(1,J), INFO)
     IF (INFO .NE. 0) EXIT
  END DO
END SUBROUTINE WBWR2
