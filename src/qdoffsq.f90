!>@brief \b QDOFFSQ computes, in quadruple precision, \f$\|G\|_F^2\f$ or \f$\|\mathop{\mathrm{off}}(G)\|_F^2\f$ of a square double precision real matrix \f$G\f$ of order \f$N\f$.
!!
