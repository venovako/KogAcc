!>@brief \b WROTRA premultiplies the rows (p,q) of G by W using an imperfect emulation of an accurate a*b+c*d operation.
SUBROUTINE WROTRA(M, N, G, LDG, P, Q, W, INFO)
