!>@brief \b WWROUT writes the BN.UJ, BN.VJ, and BN.SJ files.
SUBROUTINE WWROUT(BN, J, N, U, LDU, V, LDV, S, INFO)
  ...
  COMPLEX(KIND=c_long_double), INTENT(IN) :: U(LDU,N), V(LDV,N)
  REAL(KIND=c_long_double), INTENT(IN) :: S(N)
