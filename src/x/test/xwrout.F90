!>@brief \b XWROUT writes the BN.UJ, BN.VJ, and BN.SJ files.
SUBROUTINE XWROUT(BN, J, N, U, LDU, V, LDV, S, INFO)
  ...
  REAL(KIND=c_long_double), INTENT(IN) :: U(LDU,N), V(LDV,N), S(N)
