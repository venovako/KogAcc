!>@brief \b DSOFFSQ computes, in double precision, \f$\|G\|_F^2\f$ or \f$\|\mathop{\mathrm{off}}(G)\|_F^2\f$ of a square single precision real matrix \f$G\f$ of order \f$N\f$.
!!
...
!!@param G [IN]; \f$G\f$ is a square single precision real matrix of order \f$N\f$.
...
SUBROUTINE DSOFFSQ(O, N, G, LDG, S, INFO)
