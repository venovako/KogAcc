!>@brief \b XZOFFSQ computes, in extended precision, \f$\|G\|_F^2\f$ or \f$\|\mathop{\mathrm{off}}(G)\|_F^2\f$ of a square double precision complex matrix \f$G\f$ of order \f$N\f$.
!!
...
SUBROUTINE XZOFFSQ(O, N, G, LDG, S, INFO)
