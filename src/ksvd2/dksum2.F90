!>@brief \b DKSUM2 computes the SVD of a double precision 2x2 matrix G as G = U S V^T, assuming rounding to nearest.
!!
...
#ifdef NDEBUG
PURE SUBROUTINE DKSUM2(G, U, V, S, INFO)
  USE, INTRINSIC :: ISO_FORTRAN_ENV, ONLY: REAL64
#else
SUBROUTINE DKSUM2(G, U, V, S, INFO)
