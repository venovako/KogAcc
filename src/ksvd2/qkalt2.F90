!>@brief \b QKALT2 computes the SVD of a quadruple precision 2x2 matrix G as G = U S V^T, assuming rounding to nearest.
!!
...
#define CR_HYPOT HYPOT
  ...
  REAL(KIND=K), PARAMETER :: H = HUGE(ZERO), ROOT2 = SQRT(TWO)
#ifndef CR_MATH
  REAL(KIND=K), PARAMETER :: ROOTH = SQRT(H)
#endif
