  ...
  F = Q
#ifdef UPPER
  !$OMP PARALLEL DEFAULT(NONE) SHARED(N,NSTIME) PRIVATE(G,U,V,S,QG,QU,QV,QS,E,INFO,I,J,K,L,M,P,Q,NS) REDUCTION(MAX:F)
#else
  !$OMP PARALLEL DEFAULT(NONE) SHARED(N,NSTIME) PRIVATE(G,U,V,S,QG,QU,QV,QS,E,INFO,I,J,K,L,M,P,Q,T,NS) REDUCTION(MAX:F)
#endif
  K = 0
