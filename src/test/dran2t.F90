...
PROGRAM DRAN2T
  ...
  INTEGER(KIND=c_long_long) :: NS(2), NSTIME(2)
#else
  REAL(KIND=REAL128) :: E(5,1), F(2,8)
  INTEGER(KIND=c_long_long) :: NS(1), NSTIME(1)
#endif
  INTEGER :: I, J, K, L, M, N, INFO(3)
  INTEGER(KIND=c_int) :: O, P
  CHARACTER(LEN=64) :: CLA
  INTEGER(KIND=c_long_long), EXTERNAL :: PVN_TIME_MONO_NS
#ifdef _WIN32
  INTEGER(KIND=c_long_long), EXTERNAL :: PVN_TIME_MONO_RES
#endif
  INTEGER(KIND=c_int), EXTERNAL :: PVN_RAN_OPEN, PVN_RAN_CLOSE
  REAL(KIND=D), EXTERNAL :: PVN_RAN_SAFE
