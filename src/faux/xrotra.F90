!>@brief \b XROTRA premultiplies the rows (p,q) of G by W using an imperfect emulation of an accurate a*b+c*d operation.
SUBROUTINE XROTRA(M, N, G, LDG, P, Q, W, INFO)
