!>@brief \b QWOFFSQ computes, in quadruple precision, \f$\|G\|_F^2\f$ or \f$\|\mathop{\mathrm{off}}(G)\|_F^2\f$ of a square extended precision complex matrix \f$G\f$ of order \f$N\f$.
!!
...
!!@param G [IN]; \f$G\f$ is a square extended precision complex matrix of order \f$N\f$.
...
SUBROUTINE QWOFFSQ(O, N, G, LDG, S, INFO)
