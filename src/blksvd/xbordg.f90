!>@brief \b XBORDG borders an extended precision real square matrix of order \f$N\f$ to a matrix of order \f$M\ge N\f$.
!!
...
SUBROUTINE XBORDG(M, N, G, LDG, INFO)
  IMPLICIT NONE
