!>@brief \b YBORDG borders a quadruple precision complex square matrix of order \f$N\f$ to a matrix of order \f$M\ge N\f$.
!!
...
SUBROUTINE YBORDG(M, N, G, LDG, INFO)
