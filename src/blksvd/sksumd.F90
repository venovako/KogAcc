!>@brief \b SKSUMD computes the SVD of G as U S V^T, with S returned in SV and U and V optionally accumulated on either identity for the SVD, or on preset input matrices.
SUBROUTINE SKSUMD(JOB, N, G, LDG, U, LDU, V, LDV, SV, W, O, INFO)
  ...
  INTERFACE
#ifdef NDEBUG
     PURE SUBROUTINE SKSUM2(G, U, V, S, INFO)
#else
     SUBROUTINE SKSUM2(G, U, V, S, INFO)
#endif
       USE, INTRINSIC :: ISO_FORTRAN_ENV, ONLY: REAL32
       IMPLICIT NONE
