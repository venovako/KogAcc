!>@brief \b DMKOPQ builds at most \f$K\f$ pivot index pairs for the next transformation of \f$G\f$.
SUBROUTINE DMKOPQ(K, N, G, LDG, W, O, INFO)
...
#endif
  INTERFACE
     SUBROUTINE DABSOG(M, N, G, LDG, W, LDW, INFO)
       USE, INTRINSIC :: ISO_FORTRAN_ENV, ONLY: REAL64
       IMPLICIT NONE
