!>@brief \b XMKOPQ builds at most \f$K\f$ pivot index pairs for the next transformation of \f$G\f$.
SUBROUTINE XMKOPQ(K, N, G, LDG, W, O, INFO)
  IMPLICIT NONE
...
#define MKWPQ XMKWPQ
#define PQCMP XPQCMP
#define PQSORT XPQSORT
#include "gmkopq.F90"
END SUBROUTINE XMKOPQ
