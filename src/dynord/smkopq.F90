!>@brief \b SMKOPQ builds at most \f$K\f$ pivot index pairs for the next transformation of \f$G\f$.
SUBROUTINE SMKOPQ(K, N, G, LDG, W, O, INFO)
...
#define CR_HYPOT HYPOT
  ...
  END INTERFACE
  INTERFACE
     SUBROUTINE SPQSORT(WPQCMP, N, AW, AP, AQ, BW, BP, BQ, INFO)
       USE, INTRINSIC :: ISO_FORTRAN_ENV, ONLY: REAL32
       IMPLICIT NONE
       ABSTRACT INTERFACE
...
#define MKWPQ SMKWPQ
#define PQCMP SPQCMP
#define PQSORT SPQSORT
#include "gmkopq.F90"
END SUBROUTINE SMKOPQ
